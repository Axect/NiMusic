...
/* Command for C compiler:
   gcc -c  -w -O2 -g -pipe -Wall -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -Wp,-D_GLIBCXX_ASSERTIONS -fexceptions -fstack-protector-strong -grecord-gcc-switches -specs=/usr/lib/rpm/redhat/redhat-hardened-cc1 -specs=/usr/lib/rpm/redhat/redhat-annobin-cc1 -m64 -mtune=generic -fasynchronous-unwind-tables -fstack-clash-protection -mcet -fcf-protection -O3 -fno-strict-aliasing  -I/usr/share/nim -o /home/kavis/Documents/Project/ETC/New_Music/nimcache/stdlib_ospaths.o /home/kavis/Documents/Project/ETC/New_Music/nimcache/stdlib_ospaths.c */
...
STRING_LITERAL(TM_jvWQYw9bcuYhftfPX2ynPeg_6, "HOME", 4);
STRING_LITERAL(TM_jvWQYw9bcuYhftfPX2ynPeg_7, "/", 1);
static N_NIMCALL(void, Marker_tySequence_sM4lkSb7zS6F7OVMvW9cffQ)(void* p, NI op) {
...
{	result = (NimStringDesc*)0;
	T1_ = (NimStringDesc*)0;
	T2_ = (NimStringDesc*)0;
	T2_ = getEnv_9b1nh9cAHhSLlHOPz8lCk5FA(((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_6), ((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_3));
	T1_ = rawNewString(T2_->Sup.len + 1);
appendString(T1_, T2_);
appendString(T1_, ((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_7));
	result = T1_;
	goto BeforeRet_;
	}BeforeRet_: ;
	return result;
